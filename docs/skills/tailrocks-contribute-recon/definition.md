---
title: "Tailrocks: tailrocks-contribute-recon — Skill definition"
description: "Verbatim definition of tailrocks-contribute-recon."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-recon/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-recon/references/runtime-trust.md),
[`contribution-handoff.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-recon/references/contribution-handoff.md), and
[`project-contract.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-recon/references/project-contract.md).
