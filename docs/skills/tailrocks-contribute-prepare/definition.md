---
title: "Tailrocks: tailrocks-contribute-prepare — Skill definition"
description: "Verbatim definition of tailrocks-contribute-prepare."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-prepare/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-prepare/references/runtime-trust.md),
[`contribution-handoff.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-prepare/references/contribution-handoff.md), and
[`preparation-gate.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-prepare/references/preparation-gate.md).
