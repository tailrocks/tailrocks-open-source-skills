---
title: "Tailrocks: tailrocks-contribute-propose — Skill definition"
description: "Verbatim definition of tailrocks-contribute-propose."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-propose/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-propose/references/runtime-trust.md),
[`contribution-handoff.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-propose/references/contribution-handoff.md), and
[`etiquette-and-hard-stops.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-propose/references/etiquette-and-hard-stops.md).
