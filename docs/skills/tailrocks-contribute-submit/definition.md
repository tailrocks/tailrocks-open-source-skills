---
title: "Tailrocks: tailrocks-contribute-submit — Skill definition"
description: "Verbatim definition of tailrocks-contribute-submit."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-submit/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-submit/references/runtime-trust.md),
[`contribution-handoff.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-submit/references/contribution-handoff.md), and
[`submission-protocol.md`](https://github.com/tailrocks/tailrocks-open-source-skills/blob/main/skills/tailrocks-contribute-submit/references/submission-protocol.md).
